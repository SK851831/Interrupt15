    ...
    <body>
        <div class="container">
                        <div class="well bs-component">
                            <h1 id="initf" style="display:none;">Login Failed or you must be registered!</h1>
                            <h1 id="inits" style="display:none;">Login Successful!</h1>
        ...
        <script>
            $(document).ready(function() {
                ...
                form.on('submit', function(e) {
                    ...
                    beforeSend: function() {
                        $("#initf").hide();
                        submit.html('Interrupting....'); // change submit button text
                    },
                    success: function(data) {
                        if(data==="passed"){
                            $("#inits").show();
                            var delay1=2000; //1 seconds
                            setTimeout(function(){

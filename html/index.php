...
<div id="workshop" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h2 class="modal-title">Workshop on Ethical Hacking</h2>
			</div>
			<div class="modal-body" style="font-size:25px;">
				<?php
          if (!isset($_SESSION['email'])) {
          ?>
				<h3><a href="" data-toggle="modal" data-target="#log"class="btn btn-success" data-dismiss="modal" style=" background-color: #009688;">Login</a> to register</h3>
          <?php }else{ ?>
					For Register, <a href="work.php" class="btn btn-flat btn-primary">Here</a>
        <?php } ?>
				<li>Registration is Free.</li>
				<li>E-certificate will be given.</li>
				<li>Time: 9.00 am to 3.00 pm with breaks in-between</li>
				<li>Presented by <a href="http://www.whyglobalservices.com/">Why Global Services</a></li>
				<li>WHY Global Services was started in the year 2009 in UK with the ultimate purpose to provide dissertation support and technical training for the UK students. Later, the company has expanded its base to India and established as a comprehensive education services provider. WHY with a dynamic team of members with high calibre and expertise in various technologies provides a great support to fulfil the needs of students that include projects, corporate level technical training.</li>
			</div>
      ...
      <div class="top_content">
        <div class="row">
            <div class="text-center">
				<a href="transport.php"><button class="btn btn-lg btn-primary"> Transport </button> </a> <a href="coc.php"><button class="btn btn-success btn-md">Clash of Coders </button> </a> <a href="quizzler.php"><button class="btn btn-lg btn-primary"> Quizzler </button> </a>			<?php
          if (isset($_SESSION['email'])) {
          ?>
...
Emerge victorious!!
					...
					">So get ready to learn, teach and help the world. </p>
										...
										<li>Send your abstract along with full paper to <b>svcepapierremise2k15@gmail.com</b> on or before 29/08/2015.</li>
...
<div class="c-logo-part" style="margin-top: 0px;">
  <div class="container">
  	<h2 class="pull-left">Sponsors</h2><br><br>
    <ul class="delay-06s animated  bounce wow pull-right">
      ...
      <li ><a href="http://www.ttlship.com/"><img id="sponsers" src="img/log3.jpg" alt="" height="100px" width="200px"></a></li><br>
      <li ><a href=""  data-toggle="modal" data-target="#log4"><img id="sponsers" src="img/log4.png" alt="" height="100px" width="200px"></a></li>
      <li ><a href=""><h3 style="color:#000;font-size:20px;">Bharat Steel Industries</h3></a></li>
<li ><a href=""><img id="sponsers" src="img/logo6.png" alt="" height="200px" width="200px"></a></li> 
<li ><a href="http://www.gsstvl.com/"><img id="sponsers" src="img/logo7.png" alt="" height="100px" width="200px"></a></li>
<li ><a href="https://www.facebook.com/chaos.ec/"><img id="sponsers" src="img/logo8.jpg" alt="" height="100px" width="200px"></a></li><br><br><br>
<li ><a href=""><img id="sponsers" src="img/logo9.jpg" alt="" height="100px" width="200px"></a></li>
<li ><a href=""><img id="sponsers" src="img/logo10.jpg" alt="" height="100px" width="200px"></a></li>
...
<!--c-logo-part-end-->
<div id="log4" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h1>SSB Stationary Stores</h1>
			</div>
			<div class="modal-body">
				<div class="modal-body">
					<img src="img/log4s.png" alt="" >
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
